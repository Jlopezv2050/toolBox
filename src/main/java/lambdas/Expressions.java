...
class AnotherClass {
    ...
    String doSomething() {
        ...
        //lambda expression return the name that wraps the anonymous class because isn't a class (AnotherClass). No instance
        // of UpperConcat is created is treated like nested block and has the same scope
        UpperConcat uc = (s1, s2) -> {
