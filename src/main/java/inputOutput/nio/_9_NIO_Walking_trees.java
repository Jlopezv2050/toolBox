...
public class _9_NIO_Walking_trees {
...
//        Path directory = FileSystems.getDefault().getPath("FileTree/Dir2");  // FileTree\\Dir2 (windows)
        ...
        try {
            Files.walkFileTree(dir2Path, new _9c_NIO_PrintNames());
        } catch(IOException e) {
            System.out.println(e.getMessage());
        }
        ...
        try {
            Files.walkFileTree(dir2Path, new _9b_NIO_CopyFiles(dir2Path, copyPath));
