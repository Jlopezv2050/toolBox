...
/**
 * Using FileChannel that extends from SeekableByteChannel (has notion from current position)
 * */
public class _4_NIO_Write_inPosition {
...
//            size() - returns the size of the attached datasource
            ...
            //chained
            //buffer.putInt(234).putInt(233).putInt(23)
